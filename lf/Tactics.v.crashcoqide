...
Theorem silly2' : forall (n m o p : nat),
  ...
  [n;o] = [m;p].
Proof.
  intros n m o p eq1 eq2. apply eq2 in eq1.
  apply eq1. Qed.
...
Theorem silly2a' : forall (n m : nat),
  ...
  [n] = [m].
Proof.
  intros n m eq1 eq2. specialize (eq2 n m).
...
Theorem silly_ex : forall p,
  ...
  odd (S p) = true.
Proof.
  intros. specialize (H p). specialize (H0 (S p)). apply H in H1 as H2.
  apply H0 in H2 as H3. apply H3.
Qed.
...
Example injection_ex3 : forall (X : Type) (x y z : X) (l j : list X),
  ...
  x = y.
Proof.
  intros. rewrite H0 in H. injection H as H1 H2. transitivity z. apply H1. 
  symmetry. apply H2.
Qed.
...
Proof.
  ...
  - intro m. intro. rewrite eqb_0_l. reflexivity. apply H.
  - intro m. intro. destruct m.
    + discriminate.
    + apply f_equal. apply IHn. apply S_inj in H. apply H. 
 Qed.
...
Proof.
  ...
  - intro m. intro. destruct m.
    + discriminate.
    + apply f_equal. specialize (IHn m). 
    apply S_inj in H. apply IHn in H. apply H. 
 Qed.
...
Proof.
  ...
  - intro m. intro. destruct m.
    + discriminate.
    + apply f_equal. apply IHn in H. apply H.  
 Qed.
...
Proof.
  ...
  - destruct (f true) eqn: Ef.
    ...
    + destruct (f false) eqn: Ef2.
      ...
      * rewrite Ef2. reflexivity.
  - destruct (f false) eqn: Ef.
    + destruct (f true) eqn: Ef2.
      * apply Ef2.
      * apply Ef.
    + rewrite Ef. apply Ef.
Qed.
