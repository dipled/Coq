...
Compute incr (incr(incr(incr (B0 Z)))).
...
Proof.
  ...
  - reflexivity.
  - simpl. rewrite add_0_r. reflexivity.
  - simpl. rewrite IHb. rewrite add_0_r. rewrite add_0_r.
...
Lemma double_plus_double_double_double: forall n,
...
Lemma bin_nat_plus_double: forall b, (bin_to_nat b) + (bin_to_nat b) = double(bin_to_nat b).
Proof.
  intros.
  induction b.
  - reflexivity.
  - simpl. rewrite add_0_r. rewrite IHb. rewrite double_plus_double_double_double.
    reflexivity.
  - rewrite double_plus. reflexivity.
Qed.  

Lemma double_works_before_cast: forall b,
  nat_to_bin(double (b)) = double_bin(nat_to_bin(b)).
Proof.
  intros. induction b. 
  - reflexivity.
  - simpl. rewrite double_incr_bin. rewrite IHb. reflexivity.
Qed.

Lemma incr_double_bin_adds_one: forall b,
...
Proof.
  intros. induction b.
  - simpl. reflexivity.
  - simpl. rewrite add_assoc. rewrite bin_nat_plus_double. rewrite add_0_r.
    rewrite double_works_before_cast. rewrite IHb. reflexivity.
  - simpl. rewrite add_assoc. rewrite bin_nat_plus_double. rewrite add_0_r.
    rewrite double_works_before_cast. rewrite IHb. rewrite incr_double_bin_adds_one. reflexivity.
Qed.  
